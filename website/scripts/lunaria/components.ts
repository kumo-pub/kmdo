...
export const Meta = html`
	...
	<title>Kumo Docs Translation Status</title>
	<meta
		name="description"
		content="Translation progress tracker for the Kumo Docs site. See how much has been translated in your language and get involved!"
	/>
	<meta property="last-build" content="${new Date(Date.now()).toString()}" />
	<link rel="canonical" href="https://i18n.docs.astro.build/" />
	<meta property="og:title" content="Kumo Docs Translation Status" />
	...
	<meta
		...
		content="Translation progress tracker for the Kumo Docs site. See how much has been translated in your language and get involved!"
	/>
	<link rel="icon" href="https://docs.astro.build/favicon.svg" type="image/x-icon" />
	...
	return html`
		<main>
			<div class="limit-to-viewport">
				<h1>Kumo Docs Translation Status</h1>
