...
:::warning
    ...
    [Learn how to set up an API token, GitHub Enterprise, etc](/docs/tutorial/pub/publish/scm/github.mdx).
:::
...
:::warning
    ...
    [Learn how to set up an API token, self-hosted GitLab, etc](/docs/tutorial/pub/publish/scm/gitlab.mdx).
:::
...
:::warning
    ...
    [Learn how to set up an API token](/docs/tutorial/pub/publish/scm/gitea.mdx).
:::
...
the `--release-notes=FILE` flag. Kmdo will then skip its own release notes
...
:::info
    ...
    If you create the release before running Kmdo, and the said release
