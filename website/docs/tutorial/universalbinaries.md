...
Kmdo can create _macOS Universal Binaries_ - also known as _Fat Binaries_.
...
For more info about hooks, see the [build section](/docs/tutorial/pub/builds/hooks.mdx).
...
Most fields that support [templates](/docs/tutorial/pub/general/templates.mdx) will also
