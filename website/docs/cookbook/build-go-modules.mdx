...
- **main module**: `github.com/kumose-go/nfpm`;
- **build id**: `nfpm`
- build's `main`: `./cmd/nfpm/`;
- **current tag**: `v2.5.0`.

Kmdo will create a `go.mod` like:
...
```sh
go get github.com/kumose-go/nfpm@v2.5.0
```

And, to build, it will use something like:

```shell
go build -o nfpm github.com/kumose-go/nfpm/cmd/nfpm
```
...
[issue]: https://github.com/kumose/kmdo/issues/1354
[pr]: https://github.com/kumose/kmdo/pull/2129
[docs]: /docs/tutorial/pub/builds/verifiable_builds.mdx
