...
On Kmdo there are two main ways of doing that: the easier one is to use
the [ko integration][ko].

[ko]: /docs/tutorial/pub/archive/ko.mdx

If you don't want to, or can't, use Ko for whatever reason, this guide is for
you!

## Creating Multi-platform docker images with Kmdo

Kmdo splits the build and publish phase, which makes its usage less
obvious.
