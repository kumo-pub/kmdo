...
This cookbook is an example of a [publishers](/docs/tutorial/pub/publish/publishers.mdx)
section that uses the [jfrog cli](https://jfrog.com/getcli/) to upload files to
Artifactory. It is an alternative to using the
[Artifactory Publisher](/docs/tutorial/pub/publish/artifactory.mdx) to upload to
artifactory.
...
Example of a [publishers](/docs/tutorial/pub/publish/publishers.mdx) section pushing files
