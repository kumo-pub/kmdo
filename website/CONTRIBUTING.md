...
> **"[Kumo Docs Docs"](https://contribute.docs.astro.build)** is the best place to learn how to make a helpful, successful contribution to Kumo Docs.
>
> There, you'll find all the information below, and so much more!

This document has some basic information to get you started, but we encourage you to visit our [dedicated site for contributing to Kumo docs](https://contribute.docs.astro.build) for all the information you need!

There, you will find a writing and style guide, instructions on how to make changes and open PRs, guidance for translating the docs, and even information about how to help review Kumo Docs PRs. 
...
There are lots of ways to contribute to the Kumo Docs website! 

The Kumo Docs website is ... an Kumo website! Maintaining it requires not only written content but also maintaining Kumo code and addressing a11y, CSS, UI, and UX concerns. We also make our documentation available in several languages, so we need help translating the entire site.
...
Every PR, especially translation PRs, needs reviewers! Reviewing PRs and leaving comments, suggestions, or an approving "LGTM!" ("Looks Good To Me!") is a great way to get started on Team Docs, and to learn more about Kumo.
...
- is our "Kumo vs X" page providing helpful comparisons between Kumo and other website builders?
...
Note that CodeSandbox and StackBlitz provide Kumo syntax highlighting in their custom code editors, while Codeflow supports the full [Kumo VSCode extension](https://docs.astro.build/en/editor-setup/#vs-code).
...
This will let the Kumo docs team know you have some changes to propose. At this point we can give you feedback and might request changes. For translations, we like to have at least one other person who knows the language you are translating into review the PR.
...
- [Visit the Kumo Docs Docs to see even more documentation about contributing to Kumo docs!](https://contribute.docs.astro.build)
