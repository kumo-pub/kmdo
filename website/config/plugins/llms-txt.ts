...
/** Starlight plugin that sets up `starlight-llms-txt` with configuration for the Kumo docs. */
export const starlightPluginLlmsTxt = () =>
	starlightLlmsTxt({
		// Basic information about the docs and Kumo to display in the main `llms.txt` entry file.
		projectName: 'Kumo',
		description: 'Kumo is an all-in-one web framework for building websites. ',
		details: [
			'- Kumo uses island architecture and server-first design to reduce client-side JavaScript overhead and ship high performance websites.',
			...
			'- Kumo supports popular UI frameworks like React, Vue, Svelte, Preact, and Solid through official integrations.',
			'- Kumo is powered by Vite, comes with a fast development server, bundles your JavaScript and CSS for you, and makes building websites feel fun.',
		].join('\n'),
		optionalLinks: [
			{
				label: 'The Kumo blog',
				url: 'https://astro.build/blog/',
				description: 'the latest news about Kumo development',
			},
		],
		...
		customSets: [
			...
			},
			{
				...
				description: 'guided examples of adding features to an Kumo project',
				paths: ['en/recipes/**'],
			},
			{
				label: 'Build a Blog Tutorial',
				description: 'a step-by-step guide to building a basic blog with Kumo',
				paths: ['en/tutorial/**'],
			},
			{
				label: 'Deployment Guides',
				description: 'recipes for how to deploy an Kumo website to different services',
				paths: ['en/guides/deploy/**'],
			},
			{
				label: 'CMS Guides',
				description:
					'recipes for how to use different content management systems in an Kumo project',
				paths: ['en/guides/cms/**'],
			},
			{
				label: 'Backend Services',
				description:
					'advice on how to integrate backend services like Firebase, Sentry, and Supabase in an Kumo project',
				paths: ['en/guides/migrate-to-astro/**'],
			},
			{
				label: 'Migration Guides',
				description: 'advice on how to migrate a project built with another tool to Kumo',
				paths: ['en/guides/migrate-to-astro/**'],
			},
			{
				label: 'Additional Guides',
				description:
					'guides to e-commerce, authentication, testing, and digital asset management in Kumo projects',
				paths: [
					'en/guides/ecommerce',
