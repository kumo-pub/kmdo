...
description: 'Chocolatey Packages Releases.'
i18nReady: true
---


kmdo can also generate `nupkg` packages.
...
chocolateys:
  - # Your app's package name.
    ...
    # Setting this will prevent kmdo to actually try to push the package
...
:::tip[warning "Beware when testing this"]
...
:::note
    ...
    kmdo will not install `chocolatey`/`choco` nor any of its dependencies
    for you.
:::