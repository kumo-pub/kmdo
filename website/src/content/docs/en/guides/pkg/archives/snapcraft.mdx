...
sidebar:
  label: Snapcraft Packages
description: 'Snapcraft Packages Releases.'
i18nReady: true
---

## Snapcraft Packages (snaps)

kmdo can also generate `snap` packages.
...
:::note
    ...
    kmdo will not install `snapcraft` nor any of its dependencies for you.
:::