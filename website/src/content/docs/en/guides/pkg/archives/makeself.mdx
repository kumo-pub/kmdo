...
sidebar:
  label: Self-Extracting Archives
description: 'Self-Extracting Archives Releases.'
i18nReady: true
---


Kmdo can create self-extracting archives using [Makeself][].
...
Please refer to the [Makeself documentation](https://makeself.io/) for more information.
