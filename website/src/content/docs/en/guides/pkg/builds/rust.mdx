...
You can use [global after hooks](/en/guides/pkg/builds/hooks/) to do it:
...
You can also add them to your [global before hooks](/en/guides/pkg/builds/hooks/), e.g.:
