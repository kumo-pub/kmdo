---
title: Signing Docker
sidebar:
  label: Signing Docker
description: 'Signing Docker Releases.'
i18nReady: true
---

## Signing Docker Images and Manifests

Signing Docker Images and Manifests is also possible with kmdo.
This pipe was designed based on the common [sign](/en/guides/pkg/sig/sign/) pipe
having [cosign](https://github.com/sigstore/cosign) in mind.

:::note

    Note that this pipe will run only at the end of the kmdo execution (in
