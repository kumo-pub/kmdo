...
export default defineConfig({
	...
	integrations: [
		...
		starlight({
			...
			sidebar,
			social: [
				{ icon: 'github', label: 'GitHub', href: 'https://github.com/kumo-pub/' },
	...
	markdown: {
		...
		smartypants: false,
		remarkPlugins: [
			// @ts-expect-error — `remark-smartypants` type is not matching Kumo’s for some reason even though they both use unified’s `Plugin` type
