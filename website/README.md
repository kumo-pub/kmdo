# Kumo Docs <picture><source media="(prefers-color-scheme: dark)" srcset="https://astro.build/assets/press/astro-icon-light.png"><source media="(prefers-color-scheme: light)" srcset="https://astro.build/assets/press/astro-icon-dark.png"><img align="right" valign="center" height="79" width="63" src="https://astro.build/assets/press/astro-icon-dark.png" alt="Kumo logo" /></picture>
...
Kumo is an all-in-one web framework for building fast, content-focused websites.
We want everyone to be successful building sites, and that means helping everyone understand how Kumo works.
...
You can learn more about Kumo, get support, and meet other devs in [our Discord community](https://astro.build/chat).
...
<a href="https://i18n.docs.astro.build/">
  <img alt="Details of each language’s progress translating the Kumo Docs" width="600" src="https://i18n.docs.astro.build/summary.svg" />
</a>
